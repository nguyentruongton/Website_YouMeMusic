                ...
                <div class="container paddding">
                    <div class="row mx-0">
                        <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                            <div>
                                <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4 ymm-arial">Các bài viết</div>
                            </div>
                        <c:forEach items="${listP}" var="m">
                            <div class="row pb-4">
                                ...
                                <div class="col-md-7 animate-box">
                                    ...
                                    <a class="ymm-arial"><fmt:formatDate value="${m.ngayTao}" pattern="dd/MM/yyyy" /></a>
                                    <div class="fh5co_consectetur">
                                        <p class="ymm-text-short1 ymm-arial">${m.noiDung}</p>
                                    </div>
