                        ...
                        <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
                            ...
                            <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                                <a
                                    href="logout"
                                    role="menuitem"
                                    class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 ymm-arial"
                                    >
                                    Đăng xuất
                                </a>
...
<!--                                 User avatar button 
                                <div class="relative" x-data="{ open: false }">
                                    <button
                                        ...
                                        <img class="w-10 h-10 rounded-full" src="https://upload.wikimedia.org/wikipedia/commons/9/99/Sample_User_Icon.png" alt="Ahmed Kamel" />
                                    </button>
